# -*- coding: utf-8 -*-
"""Prepara o carrossel técnico do @peritomauricioboschetti para o Diego postar do celular.

    python preparar.py                 # a próxima peça da sequência, na próxima segunda/quinta
    python preparar.py --semana        # as duas da semana (segunda e quinta)
...
Perffec\\Claude\\Instagram-Mauricio\\<data>-<slug>\\ com slide-01..NN.jpg, legenda.txt e
...
DIAS = (0, 3)  # segunda e quinta (segunda = 0)
HORA = "7h"
...
def preparar(slug: str, data: dt.date, banco: dict) -> str:
    ...
    with open(os.path.join(pasta, "LEIA-ME.txt"), "w", encoding="utf-8") as f:
        f.write(f"{peca['titulo']}\n"
                ...
                f"legenda em legenda.txt, música fixa da conta (se houver), sem localização.\n")
