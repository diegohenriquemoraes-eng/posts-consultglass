# Pauta dos carrosséis do @peritomauricioboschetti

Regra: só entra tema com **fonte do próprio Maurício** (podcast, palestra, Reel, legenda, LP) ou
...
- Qualquer caso além dos 19 públicos (`Casos periciais do Maurício.md`) sem autorização dele.
- Estatística sem fonte (30% do VGV, 40-50% da fábrica, 90% dos casos, PBQP-H 6%) como número — só como "na experiência do perito".
- Perffec, @vendanaobra, produtos do Diego, "venda" como tema.
